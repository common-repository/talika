<?php
/**
 * Class Customer_Appointment_Approved file.
 *
 * @package Talika
 * @since  1.0.0
 */
...
if ( ! class_exists( 'Customer_Appointment_Approved', false ) ) :
	 ...
	 *
	 * @class       Customer_Appointment_Approved
	 * @extends     EmailHelpers
	 */
	class Customer_Appointment_Approved extends EmailHelpers {

		/**
		 * Constructor.
		 */
		public function __construct() {
			$this->template_html = 'emails/customer/customer-appointment-approved.php';
		...
		public function get_default_subject() {
			$subject = talika_get_array_values_by_index( $this->settings, 'customerNotification.approved.subject', '' );
		...
		public function get_content_html() {
			...
			echo wp_kses_post( wpautop( wptexturize( talika_get_template_content( 'appointment_approved', $this->template_html, 'customer' ) ) ) );

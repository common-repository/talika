<?php
/**
 * Class Employee_Appointment_Canceled file.
 *
 * @package Talika
 * @since  1.0.0
 */
...
if ( ! class_exists( 'Employee_Appointment_Canceled', false ) ) :

	/**
	 * Employee Appointment Canceled.
	 *
	 * An email sent to the employee when the appointment is canceled.
	 *
	 * @class       Employee_Appointment_Canceled
	 * @extends     EmailHelpers
	 */
	class Employee_Appointment_Canceled extends EmailHelpers {

		/**
		 * Constructor.
		 */
		public function __construct() {
			$this->template_html  = 'emails/employee/employee-appointment-canceled.php';
		...
		public function get_default_subject() {
			$subject = talika_get_array_values_by_index( $this->settings, 'staffNotification.appointmentNotification.canceled.subject', '' );
		...
		public function get_content_html() {
			...
			echo  wp_kses_post(wpautop( wptexturize( talika_get_template_content( 'appointment_canceled', $this->template_html, 'employee' ) ) ));

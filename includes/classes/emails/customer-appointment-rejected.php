<?php
/**
 * Class Customer_Appointment_Rejected file.
 *
 * @package Talika
 * @since  1.0.0
 */
...
if ( ! class_exists( 'Customer_Appointment_Rejected', false ) ) :

	/**
	 * Customer Appointment Rejected.
	 *
	 * An email sent to the customer when the appointment is rejected.
	 *
	 * @class       Customer_Appointment_Rejected
	 * @extends     EmailHelpers
	 */
	class Customer_Appointment_Rejected extends EmailHelpers {

		/**
		 * Constructor.
		 */
		public function __construct() {
			$this->template_html  = 'emails/customer/customer-appointment-rejected.php';
		...
		public function get_default_subject() {
			$subject = talika_get_array_values_by_index( $this->settings, 'customerNotification.rejected.subject', '' );
		...
		public function get_content_html() {
			...
			echo  wp_kses_post(wpautop( wptexturize( talika_get_template_content( 'appointment_rejected', $this->template_html, 'customer' ) ) ));
